...
namespace Vin\ShopwareSdk\Data\Entity\v0000\Product;
...
class ProductDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('product', new PropertyCollection([
            ...
            new Property('price', 'json_object', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('inherited', 1), new Flag('required', 1)]), []),
            ...
            new Property('availableStock', 'int', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('write_protected', [[]])]), []),
            ...
            new Property('tagIds', 'json_list', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('write_protected', [[]]), new Flag('inherited', 1)]), []),
            ...
            new Property('categories', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('cascade_delete', 1), new Flag('inherited', 1), new Flag('search_ranking', 0.25)]), [
                'entity' => 'category',
                'referenceField' => 'id',
                'localField' => 'id',
                'relation' => 'many_to_many',
            ...
            new Property('tags', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('inherited', 1), new Flag('search_ranking', 0.25)]), [
                'entity' => 'tag',
                'referenceField' => 'id',
                'localField' => 'id',
                'relation' => 'many_to_many',
