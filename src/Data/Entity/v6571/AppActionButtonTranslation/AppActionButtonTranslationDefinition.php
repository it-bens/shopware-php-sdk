...
namespace Vin\ShopwareSdk\Data\Entity\v6571\AppActionButtonTranslation;
 ...
 */
class AppActionButtonTranslationDefinition implements EntityDefinition
{
    ...
    {
        return new Schema('app_action_button_translation', new PropertyCollection([
            ...
            new Property('appActionButtonId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
            ...
            new Property('appActionButton', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'app_action_button',
                'referenceField' => 'id',
                'localField' => 'appActionButtonId',
