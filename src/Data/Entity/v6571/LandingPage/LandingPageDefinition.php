...
namespace Vin\ShopwareSdk\Data\Entity\v6571\LandingPage;
...
class LandingPageDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('landing_page', new PropertyCollection([
            ...
            new Property('tags', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1)]), [
                'entity' => 'tag',
                'referenceField' => 'id',
                'localField' => 'id',
