...
namespace Vin\ShopwareSdk\Data\Entity\v6571\ProductExport;
...
class ProductExportDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_export', new PropertyCollection([
            ...
            new Property('isRunning', 'boolean', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), []),
            ...
            new Property('storefrontSalesChannel', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
            ...
            new Property('salesChannelDomain', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
