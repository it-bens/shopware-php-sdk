...
namespace Vin\ShopwareSdk\Data\Entity\v6580\FlowSequence;
...
class FlowSequenceDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('flow_sequence', new PropertyCollection([
            ...
            new Property('flow', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'flow',
                'referenceField' => 'id',
                'localField' => 'flowId',
