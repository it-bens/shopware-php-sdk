...
namespace Vin\ShopwareSdk\Data\Entity\v65812\AppFlowEvent;
...
class AppFlowEventDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('app_flow_event', new PropertyCollection([
            ...
            new Property('flows', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1)]), [
                'entity' => 'flow',
                'referenceField' => 'appFlowEventId',
                'localField' => 'id',
