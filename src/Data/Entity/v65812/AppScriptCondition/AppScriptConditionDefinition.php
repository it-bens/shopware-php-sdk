...
namespace Vin\ShopwareSdk\Data\Entity\v65812\AppScriptCondition;
...
class AppScriptConditionDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('app_script_condition', new PropertyCollection([
            ...
            new Property('ruleConditions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('set_null_on_delete', 1)]), [
