...
namespace Vin\ShopwareSdk\Data\Entity\v65812\CountryState;
 ...
 */
class CountryStateDefinition implements EntityDefinition
{
    ...
    {
        return new Schema('country_state', new PropertyCollection([
            ...
            new Property('shortCode', 'string', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('required', 1), new Flag('search_ranking', 500)]), []),
