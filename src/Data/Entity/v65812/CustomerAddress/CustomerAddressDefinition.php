...
namespace Vin\ShopwareSdk\Data\Entity\v65812\CustomerAddress;
...
class CustomerAddressDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('customer_address', new PropertyCollection([
            ...
            new Property('zipcode', 'string', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']])]), []),
            ...
            new Property('company', 'string', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('search_ranking', 250)]), []),
            new Property('street', 'string', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('required', 1), new Flag('search_ranking', 500)]), []),
