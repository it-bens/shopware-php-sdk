...
namespace Vin\ShopwareSdk\Data\Entity\v65812\DocumentTypeTranslation;
...
class DocumentTypeTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('document_type_translation', new PropertyCollection([
            ...
            new Property('documentTypeId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
