...
namespace Vin\ShopwareSdk\Data\Entity\v65812\Integration;
...
class IntegrationDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('integration', new PropertyCollection([
            ...
            new Property('writeAccess', 'boolean', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('deprecated', unserialize('a:3:{s:16:\"deprecated_since\";s:8:\"v6.5.0.0\";s:18:\"will_be_removed_in\";s:8:\"v6.6.0.0\";s:11:\"replaced_by\";N;}'))]), []),
