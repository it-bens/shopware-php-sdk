...
namespace Vin\ShopwareSdk\Data\Entity\v65812\NewsletterRecipientTag;
...
class NewsletterRecipientTagDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('newsletter_recipient_tag', new PropertyCollection([
            ...
            new Property('newsletterRecipient', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'newsletter_recipient',
                'referenceField' => 'id',
                'localField' => 'newsletterRecipientId',
