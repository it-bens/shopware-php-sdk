...
namespace Vin\ShopwareSdk\Data\Entity\v65812\OrderLineItem;
...
class OrderLineItemDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('order_line_item', new PropertyCollection([
            ...
            new Property('promotionId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('write_protected', [['system']])]), []),
