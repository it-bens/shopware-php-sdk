...
namespace Vin\ShopwareSdk\Data\Entity\v65812\ProductDownload;
 ...
 */
class ProductDownloadDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_download', new PropertyCollection([
            ...
            new Property('product', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']])]), [
                'entity' => 'product',
                'referenceField' => 'id',
