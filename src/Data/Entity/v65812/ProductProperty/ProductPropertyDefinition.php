...
namespace Vin\ShopwareSdk\Data\Entity\v65812\ProductProperty;
...
class ProductPropertyDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_property', new PropertyCollection([
            ...
            new Property('option', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
