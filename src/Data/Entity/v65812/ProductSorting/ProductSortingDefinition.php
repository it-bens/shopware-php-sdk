...
namespace Vin\ShopwareSdk\Data\Entity\v65812\ProductSorting;
...
class ProductSortingDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_sorting', new PropertyCollection([
            ...
            new Property('translations', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('cascade_delete', 1), new Flag('inherited', 1), new Flag('required', 1)]), [
                'entity' => 'product_sorting_translation',
                'referenceField' => 'productSortingId',
                'localField' => 'id',
