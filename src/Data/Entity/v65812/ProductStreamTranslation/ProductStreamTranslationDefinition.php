...
namespace Vin\ShopwareSdk\Data\Entity\v65812\ProductStreamTranslation;
...
class ProductStreamTranslationDefinition implements EntityDefinition
{
    ...
    {
        return new Schema('product_stream_translation', new PropertyCollection([
            ...
            new Property('productStreamId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
