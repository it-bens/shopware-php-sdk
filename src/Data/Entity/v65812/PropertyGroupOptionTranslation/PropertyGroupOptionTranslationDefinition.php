...
namespace Vin\ShopwareSdk\Data\Entity\v65812\PropertyGroupOptionTranslation;
...
class PropertyGroupOptionTranslationDefinition implements EntityDefinition
{
    ...
    {
        return new Schema('property_group_option_translation', new PropertyCollection([
            ...
            new Property('propertyGroupOptionId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
            ...
            new Property('propertyGroupOption', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'property_group_option',
                'referenceField' => 'id',
                'localField' => 'propertyGroupOptionId',
