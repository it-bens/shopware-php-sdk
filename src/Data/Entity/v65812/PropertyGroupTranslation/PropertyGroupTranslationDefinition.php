...
namespace Vin\ShopwareSdk\Data\Entity\v65812\PropertyGroupTranslation;
...
class PropertyGroupTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('property_group_translation', new PropertyCollection([
            ...
            new Property('propertyGroupId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
            ...
            new Property('propertyGroup', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
