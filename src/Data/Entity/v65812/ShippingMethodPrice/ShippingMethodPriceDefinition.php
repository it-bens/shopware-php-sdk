...
namespace Vin\ShopwareSdk\Data\Entity\v65812\ShippingMethodPrice;
...
class ShippingMethodPriceDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('shipping_method_price', new PropertyCollection([
            ...
            new Property('calculationRule', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'rule',
                'referenceField' => 'id',
                'localField' => 'calculationRuleId',
                'relation' => 'many_to_one',
            ]),
