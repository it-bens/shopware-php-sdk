...
namespace Vin\ShopwareSdk\Data\Entity\v65812\Theme;
...
class ThemeDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('theme', new PropertyCollection([
            ...
            new Property('themeJson', 'json_object', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'properties' => json_decode('[]', true),
            ]),
            ...
            new Property('previewMedia', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'media',
                'referenceField' => 'id',
                'localField' => 'previewMediaId',
                'relation' => 'many_to_one',
            ]),
            new Property('dependentThemes', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'theme',
                'referenceField' => 'id',
                'localField' => 'id',
                'relation' => 'many_to_many',
