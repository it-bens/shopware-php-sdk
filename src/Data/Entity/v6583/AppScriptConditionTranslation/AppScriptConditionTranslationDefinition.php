...
namespace Vin\ShopwareSdk\Data\Entity\v6583\AppScriptConditionTranslation;
 ...
 */
class AppScriptConditionTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('app_script_condition_translation', new PropertyCollection([
            ...
            new Property('appScriptConditionId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
            ...
            new Property('appScriptCondition', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'app_script_condition',
                'referenceField' => 'id',
                'localField' => 'appScriptConditionId',
