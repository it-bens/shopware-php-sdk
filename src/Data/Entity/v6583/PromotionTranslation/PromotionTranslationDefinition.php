...
namespace Vin\ShopwareSdk\Data\Entity\v6583\PromotionTranslation;
...
class PromotionTranslationDefinition implements EntityDefinition
{
    ...
    {
        return new Schema('promotion_translation', new PropertyCollection([
            ...
            new Property('promotionId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
