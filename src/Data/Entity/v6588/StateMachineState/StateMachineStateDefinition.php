...
namespace Vin\ShopwareSdk\Data\Entity\v6588\StateMachineState;
...
class StateMachineStateDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('state_machine_state', new PropertyCollection([
            ...
            new Property('fromStateMachineTransitions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'state_machine_transition',
                'referenceField' => 'fromStateId',
                'localField' => 'id',
                'relation' => 'one_to_many',
            ]),
            new Property('toStateMachineTransitions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'state_machine_transition',
            ...
            new Property('orderTransactions', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'order_transaction',
                'referenceField' => 'stateId',
                'localField' => 'id',
                'relation' => 'one_to_many',
            ]),
            new Property('orderDeliveries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
            ...
            new Property('orderTransactionCaptures', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'order_transaction_capture',
                'referenceField' => 'stateId',
                'localField' => 'id',
                'relation' => 'one_to_many',
            ]),
            new Property('orderTransactionCaptureRefunds', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
            ...
            new Property('toStateMachineHistoryEntries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'state_machine_history',
                'referenceField' => 'toStateId',
                'localField' => 'id',
                'relation' => 'one_to_many',
            ]),
            new Property('fromStateMachineHistoryEntries', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'state_machine_history',
                'referenceField' => 'fromStateId',
                'localField' => 'id',
                'relation' => 'one_to_many',
