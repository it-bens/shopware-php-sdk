...
namespace Vin\ShopwareSdk\Data\Entity\v6640\ScheduledTask;
...
class ScheduledTaskDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('scheduled_task', new PropertyCollection([
            ...
            new Property('defaultRunInterval', 'int', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('required', 1)]), []),
