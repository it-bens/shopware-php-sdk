...
namespace Vin\ShopwareSdk\Data\Entity\v6650\StateMachineHistory;
...
class StateMachineHistoryDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('state_machine_history', new PropertyCollection([
            ...
            new Property('referencedId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('required', 1)]), []),
            new Property('referencedVersionId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]), new Flag('required', 1)]), []),
