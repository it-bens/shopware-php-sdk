...
namespace Vin\ShopwareSdk\Data\Entity\v6660\ImportExportProfileTranslation;
...
class ImportExportProfileTranslationDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('import_export_profile_translation', new PropertyCollection([
            ...
            new Property('importExportProfile', 'association', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), [
                'entity' => 'import_export_profile',
                'referenceField' => 'id',
                'localField' => 'importExportProfileId',
