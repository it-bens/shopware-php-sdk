...
namespace Vin\ShopwareSdk\Data\Entity\v6660\StateMachineTranslation;
...
class StateMachineTranslationDefinition implements EntityDefinition
{
    ...
    {
        return new Schema('state_machine_translation', new PropertyCollection([
            ...
            new Property('stateMachineId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('primary_key', 1), new Flag('required', 1)]), []),
