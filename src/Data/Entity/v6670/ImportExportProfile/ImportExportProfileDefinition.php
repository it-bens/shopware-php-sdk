...
namespace Vin\ShopwareSdk\Data\Entity\v6670\ImportExportProfile;
...
class ImportExportProfileDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('import_export_profile', new PropertyCollection([
            ...
            new Property('technicalName', 'string', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']])]), []),
