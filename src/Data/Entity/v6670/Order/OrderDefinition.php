...
namespace Vin\ShopwareSdk\Data\Entity\v6670\Order;
...
class OrderDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('order', new PropertyCollection([
            ...
            new Property('customerComment', 'text', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('allow_empty_string', 1)]), []),
