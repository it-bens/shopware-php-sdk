...
class ProductDefinition implements EntityDefinition
{
    ...
    public function getSchema(): Schema
    {
        return new Schema('product', new PropertyCollection([
            ...
            new Property('canonicalProductVersionId', 'uuid', new FlagCollection([new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource']]), new Flag('inherited', 1), new Flag('required', 1)]), []),
